...
class RoutineGenerator:
    ...
    def _generate_preamble(self, ctx: GeneratorContext) -> None:
        ...
        # Spec 010: Import $ORDER and $QUERY helpers (Phase 2)
        ctx.emitter.line(
            "from m2py.runtime.helpers import m_set_piece, m_set_extract, m_data, m_data_global, m_order, m_order_global, m_query, m_query_global"
        )
