...
CATEGORIES = {
    ...
    'Binary Operator Tests A': ['V1BOA.m', 'V1BOA1.m', 'V1BOA2.m', 'V1BOA3.m', 'V1BOA4.m', 'V1BOA5.m', 'V1BOA6.m'],
    'Binary Operator Tests B': ['V1BOB.m', 'V1BOB1.m', 'V1BOB10.m', 'V1BOB2.m', 'V1BOB3.m', 'V1BOB4.m', 'V1BOB5A.m', 'V1BOB5B.m', 'V1BOB6A.m', 'V1BOB6B.m', 'V1BOB7.m', 'V1BOB8.m', 'V1BOB9.m'],
    ...
    'FOR Loop Tests': ['V1FORA.m', 'V1FORA1.m', 'V1FORA2.m', 'V1FORB.m', 'V1FORC.m', 'V1FORC1.m', 'V1FORC2.m'],
    'GOTO Tests': ['V1GO.m', 'V1GO1.m', 'V1GO2.m'],
    'HANG Command Tests': ['V1HANG.m'],
    'Indirection Tests - Arguments': ['V1IDARG.m', 'V1IDARG1.m', 'V1IDARG2.m', 'V1IDARG3.m', 'V1IDARG4.m', 'V1IDARG5.m'],
...
def detect_issues(filepath: Path, routine: Any) -> list[dict]:
    ...
    label_lines = [l for l in code_lines if l and l[0] not in ' \t']
    statement_lines = len(code_lines) - len(label_lines)
    
    total_statements = sum(
        len(label.body.statements) if label.body else 0
...
def validate_category(category_name: str, files: list[str], parser: MUMPSParser, mugj_dir: Path) -> dict:
        ...
        if results['issues']:
            ...
            for issue_entry in results['issues']:
                if 'error' in issue_entry:
                    ...
                    print(f"     {issue_entry['file']}: {len(issue_entry['issues'])} issue(s)")
