...
REMAINING_CATEGORIES = {
    ...
    'Priority Tests': ['V1PRFOR.m', 'V1PRGD.m', 'V1PRGD1.m', 'V1PRGD2.m', 'V1PRGD3.m', 'V1PRIE.m', 'V1PRSET.m'],
    'READ Command Tests': ['V1READA.m', 'V1READA1.m', 'V1READA2.m', 'V1READB.m', 'V1READB1.m', 'V1READB2.m'],
    ...
    'Unary Operator Tests': ['V1UO.m', 'V1UO1A.m', 'V1UO1B.m', 'V1UO2A.m', 'V1UO2B.m', 'V1UO3A.m', 'V1UO3B.m', 'V1UO4A.m', 'V1UO4B.m', 'V1UO5A.m', 'V1UO5B.m'],
    'WRITE Command Tests': ['V1WR.m'],
    'XECUTE Command Tests': ['V1XECA.m', 'V1XECA1.m', 'V1XECA2.m', 'V1XECAE.m', 'V1XECB.m'],
}
        ...
        for filename in files:
            ...
            if result['parsed']:
                ...
                if result['io_commands']:
                    ...
                    io_summary = ', '.join(set(cmd['command'] for cmd in result['io_commands']))
