...
MVTS_VV1_ROUTINES: list[RoutineDefinition] = [
    ...
    RoutineDefinition("4---V1LL1", "V1LL1", expected_passes=12),
    RoutineDefinition("5---V1LL2", "V1LL2", expected_passes=8),
    RoutineDefinition("6---V1LL3", "V1LL3", expected_passes=13),
    ...
    RoutineDefinition("135.1---V1PC", "V1PC", expected_passes=18, expected_fails=2),
    ...
    RoutineDefinition("177---V1SVS", "V1SVS", expected_passes=4),
...
MVTS_VV2_ROUTINES: list[RoutineDefinition] = [
    ...
    RoutineDefinition("2---V2LCC1", "V2LCC1", expected_passes=10, expected_fails=2),
...
MVTS_VV4_ROUTINES: list[RoutineDefinition] = [
    ...
    RoutineDefinition(
        ...
        "V4KEY",
        expected_passes=3,
        skip_reason="All tests require interactive READ input ($KEY terminator)",
    ),
