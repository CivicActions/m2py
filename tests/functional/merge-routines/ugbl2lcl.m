ugbl2lcl ; Unicode global-to-local MERGE test
 ; Extracted from u_inref/ugbl2lcl.input
 set cnt=1
 ...
 zwr new1
 set ^var1longnamevariableswork4merge(1,2,3)="long global to local"
 ...
 MERGE @longvar@("αβγδε①②③④⑤⑥⑦⑧")=^var1longnamevariableswork4merge(1,2,3)
