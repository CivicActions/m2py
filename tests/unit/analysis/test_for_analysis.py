"""Tests for FOR loop analysis.

Migrated from: tests/unit/test_goto_for_analysis.py::TestAnalyzeForLoops
Migrated from: tests/unit/test_goto_for_analysis.py::TestForLoopIsInfinite
Migrated from: tests/unit/test_goto_for_analysis.py::TestIntegrationWithParser
Migrated from: tests/unit/test_goto_for_analysis.py::TestForAnalysisNestedScopes
Migrated from: tests/unit/test_goto_for_analysis.py::TestLoopVarModificationEnhanced
Migrated from: tests/unit/test_goto_for_analysis.py::TestSignatureAwareByRefDetection

Tests for:
- analyze_for_loops() function
- FOR loop is_infinite detection
- loop_var_modified_in_body detection
- has_internal_quit detection
- Nested scope recursion for variable modification and QUIT detection
- READ, KILL, and pass-by-reference detection for loop var modification
