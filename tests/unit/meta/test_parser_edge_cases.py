...
Miscellaneous parser tests that don't fit into specific spec sections.
These cover grammar enhancements and edge cases discovered during development.
...
class TestPartOEdgeCases:
    ...
    Migrated from: tests/unit/test_command_grammar.py::TestPartOEdgeCases
    """
...
class TestUnknownCommand:
    ...
    Migrated from: tests/unit/test_command_grammar.py::TestUnknownCommand
    """
...
class TestFunctionArgsEmpty:
    ...
    Migrated from: tests/unit/test_command_grammar.py::TestFunctionArgsEmpty
    """
