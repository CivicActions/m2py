...
Migrated from: tests/unit/test_semantic_analyzer.py::TestReadFixedLength
"""
...
class TestReadCommandAnalysis:
    ...
    Migrated from: TestReadFixedLength
    """

    def test_read_fixed_length_basic(self):
        """R X#5 should produce MReadTarget with fixed_length (§8.2.17)."""
    ...
    def test_read_fixed_length_with_timeout(self):
        """R X#5:10 should have both fixed_length and timeout (§8.2.17)."""
    ...
    def test_read_fixed_length_variable(self):
        """R X#N should have variable as fixed_length (§8.2.17)."""
