...
class TestIfCommaConditions:
    ...
    def test_if_conditions_in_line_with_other_commands(self):
        ...
        assert len(commands) >= 3, f"Expected at least 3 commands, got {len(commands)}: {[c.__class__.__name__ for c in commands]}"
...
class TestV1BRLine37:
    ...
    def test_v1br_line37_parses(self):
        ...
        expected_types = ['ForCommand', 'ForCommand', 'SetCommand', 'IfCommand',
                          'SetCommand', 'WriteCommand', 'BreakCommand', 'SetCommand']
