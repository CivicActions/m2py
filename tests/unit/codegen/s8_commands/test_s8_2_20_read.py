"""Tests for READ command code generation.

Spec 011 Phase 20 (T083-T086): Generate Python for READ command
that reads user input from stdin.

User Story 18: Generate Python for R X and R X:timeout that reads user input.
"""
