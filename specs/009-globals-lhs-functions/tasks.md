...
- [ ] T050 [P] Update `docs/coverage-matrix.md` with spec 009 features
- [ ] T051 [P] Run all acceptance scenarios from quickstart.md via validate.py
- [ ] T052 Run full test suite: `uv run pytest tests/test_spec_009*.py -v`
- [ ] T053 Verify generated Python passes `ast.parse()` for all scenarios
- [ ] T054 Performance check: `time uv run pytest tests/test_spec_009*.py -q` completes in <5 seconds real time
