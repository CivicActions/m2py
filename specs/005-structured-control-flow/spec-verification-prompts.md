...
Go through all of the 006 spec, plan documents, tasks, chat backlog and git branch commits, then identify if there are any documentation changes needed. Document the current state only - avoid "change" language.
Then, check the codegen-plan and make any corrections or important notes needed for spec 007+ there - make changes in context, avoiding "change" language.